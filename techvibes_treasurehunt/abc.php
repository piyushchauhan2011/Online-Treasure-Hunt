...
if ($image) 
{
	...
	else
	{
		...
		mysql_query("insert into questions (questionpath,answer,hint1,hint2,hint3) values('".$newname."','$ans','$hint1','$hint2','$hint3')");
	}
	...
	if($rs)
		...
		{
		 ?>
		 <img width="150" src="<?php echo $row['questionpath'];?>"><br>
		 <?php 
		}
}
?>